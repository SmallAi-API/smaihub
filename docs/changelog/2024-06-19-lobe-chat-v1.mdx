...
description: >-
  LobeHub 1.0 brings a brand-new architecture and features for server-side databases and user authentication management, opening up new possibilities. On this basis, LobeHub Cloud has entered beta testing.
