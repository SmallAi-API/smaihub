...
description: >-
  LobeHub v1.6 has been released with support for GPT-4o mini, while LobeHub Cloud services have been fully upgraded to provide users with a more powerful AI conversation experience.
