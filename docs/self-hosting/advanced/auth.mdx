...
<Callout type={'info'}>
  Looking for legacy authentication methods? See [Legacy
  Authentication](/docs/self-hosting/advanced/auth/legacy) for NextAuth and Clerk documentation.
</Callout>
...
<Card
  href={'/docs/self-hosting/advanced/auth/providers/cloudflare-zero-trust'}
