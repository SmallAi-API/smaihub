...
description: >-
  Guide for migrating your LobeChat deployment from Clerk authentication to Better Auth, including simple and full migration options.
...
<Callout type={'tip'}>
  ...
  Configuration](/docs/self-hosting/advanced/auth).
</Callout>
