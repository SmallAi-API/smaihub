...
<Callout type={'warning'}>
  **旧版提示**：NextAuth 和 Clerk 是旧版身份验证方案。对于新部署，我们强烈建议使用 [Better
  Auth](/zh/docs/self-hosting/advanced/auth)，它更简洁、更灵活。
</Callout>
...
<Callout type={'tip'}>
  ...
  迁移指南](/zh/docs/self-hosting/advanced/auth/clerk-to-betterauth)。
</Callout>
...
<Callout type={'tip'}>
  ...
  迁移指南](/zh/docs/self-hosting/advanced/auth/nextauth-to-betterauth)。
</Callout>
