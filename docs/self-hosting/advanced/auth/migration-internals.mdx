...
description: >-
  Technical explanation of how authentication migration works in LobeChat, including database schema, migration principles, and troubleshooting guide.
...
<Callout type={'info'}>
  ...
  Migration](/docs/self-hosting/advanced/auth/nextauth-to-betterauth) or [Clerk
  Migration](/docs/self-hosting/advanced/auth/clerk-to-betterauth).
</Callout>
...
<Card
  href={'/docs/self-hosting/advanced/auth/clerk-to-betterauth'}
