...
description: >-
  Learn how to configure Casdoor SSO for LobeChat, including creating an application and setting up environment variables.
...
<Callout type="important">
  ...
  ⚠️ Please do not enable any form of caching in the reverse proxy settings of such panel software to avoid affecting the normal operation of the service. See [https://github.com/lobehub/lobe-chat/discussions/5986](https://github.com/lobehub/lobe-chat/discussions/5986)
</Callout>
