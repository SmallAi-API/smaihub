...
description: >-
  Learn how to configure AWS Cognito SSO for LobeChat, including creating a User Pool and App Client in AWS Console.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with AWS Cognito and use LobeChat.
</Callout>
