...
description: >-
  Learn how to configure Feishu (Lark) SSO for LobeChat, including creating an application and setting up environment variables.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Feishu and use LobeChat.
</Callout>
