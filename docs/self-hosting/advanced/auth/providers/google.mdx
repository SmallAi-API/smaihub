...
description: >-
  Learn how to configure Google SSO for LobeChat, including creating OAuth credentials in Google Cloud Console and setting up environment variables.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Google and use LobeChat.
</Callout>
