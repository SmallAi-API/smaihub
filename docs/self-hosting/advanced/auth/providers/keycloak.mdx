...
description: >-
  Learn how to configure Keycloak SSO for LobeChat, including creating a client and setting up environment variables.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Keycloak and use LobeChat.
</Callout>
