...
description: >-
  Learn how to configure Microsoft (Entra ID / Azure AD) SSO for LobeChat, including creating applications in Azure Portal and setting up environment variables.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Microsoft and use LobeChat.
</Callout>
