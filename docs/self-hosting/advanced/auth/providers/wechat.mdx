...
description: >-
  Learn how to configure WeChat SSO for LobeChat, including creating an application on WeChat Open Platform.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with WeChat and use LobeChat.
</Callout>
