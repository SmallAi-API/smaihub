...
description: >-
  Enhance your LobeHub applications with open-source observability and tracing using Langfuse. Automatically capture detailed traces and metrics for every request to optimize and debug your chats.
...
<Image
  alt={'LobeHub Conversation'}
  src={'https://langfuse.com/images/docs/LobeHub-converstation.png'}
/>
...
<Image
  alt={'LobeHub Example Trace'}
  src={'https://langfuse.com/images/docs/LobeHub-example-trace.png'}
/>
