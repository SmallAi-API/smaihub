...
`pg_search`。现有项目的停用安排以 Neon 发给该项目的通知为准；收到停用通知的 LobeHub 用户应在通知中的截止日期前完成
[Neon pg\_search 迁移](/zh/docs/self-hosting/advanced/neon-pg-search-migration)。当前部署在选择搜索后端前，请先阅读
