...
description: >-
  Connect your LobeHub agents to external messaging platforms like Discord, Slack, Telegram, QQ, WeChat, Feishu, and Lark, allowing users to interact with AI assistants directly in their favorite chat apps.
