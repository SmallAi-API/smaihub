...
description: >-
  Learn how to add and use custom plugins in LobeHub, including creating a plugin project, adding local plugins in role settings, testing plugin functionality, and understanding the development and deployment process.
...
<Image
  alt="Create and Start Plugin Project"
  height={483}
  inStep
...
<Image
  alt="Add Local Plugin in LobeHub Role Settings S1"
  height={483}
  inStep
...
<Image
  alt="Add Local Plugin in LobeHub Role Settings S2"
  height={483}
  inStep
...
<Image
  alt="Add Local Plugin in LobeHub Role Settings S3"
  height={483}
  inStep
...
<Image
  alt="Add Local Plugin in LobeHub Role Settings S4"
  height={483}
  inStep
...
Click <kbd>Back</kbd> to return to the chat area, and send a message like: “What should I wear?” The assistant will ask for your gender and current mood.

<Image
  alt="Test Plugin Functionality S1"
  height={483}
  inStep
...
<Image
  alt="Test Plugin Functionality S2"
  height={483}
  inStep
