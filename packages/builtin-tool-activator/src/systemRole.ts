...
- User wants to use, open, connect, or interact with a third-party integration service
  (e.g., Gmail, Google Calendar, Google Sheets, Google Docs, Google Drive,
   Supabase, Slack, Figma, OneDrive, Outlook Mail, WhatsApp,
   YouTube, GitHub, Notion, LinkedIn, Cloudflare)
- User says things like "help me use Notion", "connect my Slack", "open Google Drive",
  "send a Gmail", "post to LinkedIn", "manage my Cloudflare DNS"
  — these are third-party OAuth services
