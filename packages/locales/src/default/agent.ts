export default {
  ...
  'channel.comingSoonDesc':
    'We are working on bringing this integration to smai.ai Stay tuned for updates.',
  ...
  'channel.imessage.description':
    'Connect this agent to iMessage through the local smai.ai Desktop BlueBubbles bridge.',
  ...
  'channel.imessage.blueBubblesPasswordHint':
    'Stored locally in smai.ai Desktop and used only to call the local BlueBubbles server.',
  ...
  'channel.imessage.blueBubblesServerUrlTip':
    'If BlueBubbles and smai.ai Desktop run on the same Mac, use 127.0.0.1; if they run on different devices, enter the LAN IP.',
  'channel.imessage.bridgeEnabled': 'Enable Bridge',
  'channel.imessage.bridgeEnabledHint':
    'When enabled, smai.ai Desktop receives local BlueBubbles webhooks and forwards them to smai.ai.',
  'channel.imessage.bridgeRunningDesc':
    'This local relay forwards iMessage messages to smai.ai. You can now test the BlueBubbles connection.',
  'channel.imessage.bridgeRunningDescListening':
    'Listening on {url}, relaying iMessage messages to smai.ai. You can now test the BlueBubbles connection.',
  ...
  'channel.imessage.bridgeStoppedDesc':
    'Enable the bridge to relay iMessage messages to smai.ai, then test the connection.',
  ...
  'channel.imessage.desktopDeviceIdHint':
    'The smai.ai Desktop device that runs the local BlueBubbles bridge. Find it in Desktop Gateway settings.',
  ...
  'channel.imessage.webhookSecretHint':
    'A shared secret used between smai.ai Desktop and the cloud webhook. Use the same value in the Desktop bridge config.',
