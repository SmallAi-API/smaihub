export default {
  ...
  'createModal.skillSuggestion.actions.tryInLobeAI': 'Use in smai',
  ...
  'createModal.skillSuggestion.installed.description':
    'You can use this Skill in smai or add it to any Agent.',
  'createModal.skillSuggestion.installed.ready': 'Ready in smai',
