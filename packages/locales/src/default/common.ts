export default {
  ...
  'productHunt.actionLabel': 'Download Now',
  'productHunt.description': 'Click below to download the Windows client for the best experience!',
  'productHunt.title': "We've launched the Windows Client!",
