export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve smai.ai. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve smai.ai',
  ...
  'screen5.actions.signInCloud': 'Sign in to smai.ai Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your smai.ai Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'smai.ai',
  'screen5.methods.selfhost.description': 'Connect to your own smai.ai server instance',
  ...
  'screen5.status.cloud.title': 'Connected to smai.ai Cloud',
