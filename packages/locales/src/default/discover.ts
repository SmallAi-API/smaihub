export default {
  ...
  'createGuide.func1.title': 'Submit in smai.ai',
  ...
  'models.providerInfo.apiTooltip': 'smai.ai supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'smai.ai Official Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': 'Use on smai.ai',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by smai.ai automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the smai.ai marketplace with one click.',
