export default {
  ...
  'dashboard.task.unsupportedContext':
    'Task mode does not support attachments or selected context yet. Remove them or switch to Chat; your draft has been kept.',
  ...
  'recommendations.heteroAgent.description':
    'Detected the {{name}} CLI on this device — add {{name}} agent to chat with it from smai.ai',
  ...
  'starter.claudeOpus48': 'Claude Opus 4.8',
  'starter.NewModelAlready': 'Already using Claude Opus 4.8',
