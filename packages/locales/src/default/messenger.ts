export default {
  ...
  'messenger.slack.installBlocked.suggestion':
    "DM @smai.ai on Slack to link your personal account — you don't need to install again. Or ask the original installer to disconnect this workspace first if you want to take over ownership.",
  ...
  'messenger.list.discord.description':
    'Chat with your smai.ai agents on Discord by DMing the smai.ai bot from any server.',
  ...
  'verify.success.backToLobeHub': 'Back to smai.ai',
