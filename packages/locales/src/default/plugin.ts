export default {
  ...
  'builtins.lobe-task.goal.cancel': 'Cancel',
  'builtins.lobe-task.goal.criterionTitle': 'Title',
  'builtins.lobe-task.goal.editCriterion': 'Edit criterion C{{seq}}',
  'builtins.lobe-task.goal.judgePrompt': 'Judge prompt',
  'builtins.lobe-task.goal.requiredHint': 'Required — the goal cannot pass while this fails',
  'builtins.lobe-task.goal.roundBudget': 'Iteration budget',
  'builtins.lobe-task.goal.save': 'Save',
  'builtins.lobe-task.goal.verifier.agent': 'Agent verification',
  'builtins.lobe-task.goal.verifier.llm': 'Model judgement',
  'builtins.lobe-task.goal.verifier.program': 'Programmatic check',
  'builtins.lobe-task.goal.verifierType': 'Verification method',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.dismiss': 'Dismiss',
  'skillInstallBanner.title': 'Connect your favorite apps to smai.ai',
