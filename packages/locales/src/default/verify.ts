export default {
  ...
  'acceptance.ledger.count': '{{count}} round(s)',
  'acceptance.ledger.description':
    'Each round is one full verification run; the main list is the cross-round merge. Trace the full history here.',
  'acceptance.ledger.expand': 'Expand the round ledger',
  'acceptance.ledger.latest': 'Latest',
  'acceptance.ledger.stats': '{{passed}}/{{total}} passed',
