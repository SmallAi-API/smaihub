...
const CreatePlatformAgentContent = memo<CreatePlatformAgentContentProps>(({ groupId }) => {
  ...
  }, [step, agentProfile, fetchingProfile, agentName, selectedPlatformDef.name, agentDescription]);
              ...
              description={
                <Flexbox gap={12}>
                  <Flexbox gap={6}>
                    ...
                    <a href="https://www.smallai.asia/download" rel="noreferrer" target="_blank">
