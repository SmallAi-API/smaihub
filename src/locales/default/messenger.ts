export default {
  ...
  'messenger.linkModal.instructions':
    'Open the bot, send /start, then tap "Link Account" to connect your smai.ai account.',
  ...
  'messenger.slack.connectModal.description':
    'You will be redirected to Slack to authorize the smai.ai workspace install.',
  ...
  'messenger.slack.connections.disconnectConfirm':
    'Disconnect the smai.ai bot from this Slack workspace? Existing user links will pause until you re-install.',
  ...
  'messenger.slack.installBlocked.suggestion':
    "DM @smai.ai in Slack to link your personal account — you don't need to install again. Or ask the original installer to disconnect this workspace first if you want to take over ownership.",
  ...
  'messenger.slack.installBlocked.withoutName':
    'This Slack workspace is already connected to smai.ai by another user.',
  ...
  'messenger.discord.connectModal.description':
    'Add the smai.ai bot to a Discord server you manage.',
  ...
  'messenger.list.discord.description':
    'Chat with your smai.ai agents from any Discord server via DM with the smai.ai bot.',
  'messenger.list.slack.description':
    'Chat with your smai.ai agents from any Slack workspace via DM or @smai.ai.',
  'messenger.list.telegram.description':
    'Chat with your smai.ai agents in Telegram and pick which one answers from anywhere.',
  'messenger.setActiveFailed': 'Failed to set as active.',
  'messenger.setActiveSuccess': 'Active agent updated.',
  'messenger.subtitle':
    'Connect your account to the official smai.ai bot once. Pick which agent receives messages, switch any time from here or from the bot.',
  ...
  'verify.confirm.fields.lobeHubAccount': 'smai.ai account',
  'verify.confirm.fields.platformAccount': '{{platform}} account',
  'verify.confirm.fields.workspace': 'Workspace',
  'verify.confirm.noAgents':
    "You don't have any agents yet. Create one in smai.ai, then come back to finish linking.",
  'verify.confirm.relink.description':
    'This smai.ai account is already linked to {{platform}} account {{account}}. To link a different {{platform}} account, disconnect the current one first in Settings → Messenger.',
  ...
  'verify.error.alreadyConsumed':
    'This link has already been used to connect an account. Sign in to that smai.ai account to manage the connection, or return to the bot and send /start again to issue a new link.',
  'verify.error.alreadyConsumedTitle': 'This link is already used',
  'verify.error.alreadyLinkedToOther':
    'This account is already linked to a different smai.ai account. Sign in to that account first.',
  ...
  'verify.error.unlinkBeforeRelink':
    'This smai.ai account is already linked to another account on this platform. Disconnect it in Settings → Messenger before linking a new one.',
  'verify.signInCta': 'Sign in to continue',
  'verify.signInRequired': 'Please sign in to smai.ai to confirm the link.',
