export default {
  ...
  'klavis.apiKey.clear': 'Clear',
  'klavis.apiKey.cleared': 'Klavis API key cleared',
  'klavis.apiKey.configured': 'Configured',
  'klavis.apiKey.description':
    'Enter your personal Klavis API key. Each user needs their own key to avoid hitting the shared account quota when connecting MCP servers.',
  'klavis.apiKey.getKey': "Don't have a Klavis key yet? <1>Get one at klavis.ai</1>.",
  'klavis.apiKey.notConfigured': 'Not configured',
  'klavis.apiKey.placeholder': 'sk-klavis-...',
  'klavis.apiKey.save': 'Save',
  'klavis.apiKey.saved': 'Klavis API key saved',
  'klavis.apiKey.title': 'Klavis API Key',
  'klavis.modal.cancel': 'Cancel',
  'klavis.modal.description':
    'Connecting MCP servers requires your personal Klavis API key. Save it once and we will continue with the connection.',
  'klavis.modal.empty': 'API key is required',
  'klavis.modal.openSettings': 'Open Klavis settings',
  'klavis.modal.saveAndContinue': 'Save & continue',
  'klavis.modal.title': 'Set your Klavis API key',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tools.builtins.lobe-skill-store.description':
    'Browse and install agent skills from the marketplace. Use this when you need extended capabilities or want to install a specific skill.',
